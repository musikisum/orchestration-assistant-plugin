...
const one = ({ toneName }) => {
  ...
  return (
    <div>
      <p><b><i>Das {toneName[0]}&apos; liegt in der eingestrichenen Oktave.</i></b></p>
      <h1>Die eingestrichene Oktave</h1>
      <p>
        Töne in der engestrichenen Oktave können im Orchester von gespielt werden von
      </p>
      <ul>
        <li>Streichern,</li>
        <li>Klarinette,</li>
        <li>vom Englischhorn</li>
        <li>Fagott,</li>
        <li>Saxofon,</li>
        <li>Horn und</li>
        <li>von der Trompete (Schmetterlage).</li>
      </ul>
      <p>
        ...
        Für die <b>Posaune</b> ist die eingestrichene Oktave eine hohe, virtuose Lage.<br />
        Für die Oboe ist die eingestrichene Oktave eine tiefe, jedoch noch brauchbare Lage mit einem etwas dicken (in tiefster Lage auch schwerfälligen) Klang (vgl. G. Mahler, Kindertotenlieder (Orchesterfassung), Nr. 1, &raquo;Nun will die Sonn&apos; so hell aufgeh&apos;n!&laquo;).<br />
        Für die <b>Bassklarinette</b> und <b>Tuba</b> liegen Töne der eingestrichen Oktave im höchsten Register.
      </p>
      <p>
      ...
      <ul>
        <li>Piccoloflöte (und Sopranblockflöte)</li>
        <li>die Flöte klingt in dieser tiefen Lage zwar voll, jedoch leise und hauchig (kann zum Abdecken von Streichern und Klarinetten verwendet werden)</li>
        <li>Tuba</li>
        <li>Kontrafagott</li>
        <li>Kontrabass</li>
      </ul>
