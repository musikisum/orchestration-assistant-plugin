...
export default function Flute({ from, to, row }) {
  ...
  const [begin, end] = OrchestrationUtilities.calculateGridColumnsForInstruments(22, 44, from, to); 
    ...
    <div className='instrument instrument-brass' style={{ gridColumn: calculation, gridRow: row }}>
      ...
      {isVisible
        ...
        <div className="instrument-annotations">
            <p>Die Querflöte (obwohl üblicherweise aus Metall und ohne Rohrblatt) zählt zu den Holzblasinstrumenten (historische Instrumente in Holzbauweise).</p>
            ...
            <p><b>Literaturbeispiele für eine solistische Flöte im Orchestersatz (oder in einer Rockband):</b></p>
            <ul>
