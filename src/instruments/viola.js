    ...
    <div className='instrument instrument-strings' style={{ gridColumn: calculation, gridRow: row }}>
      ...
      {isVisible
        ...
        <div className="instrument-annotations">
          <p>Die Viola (Bratsche) ist das Altinstrument der Geigenfamilie (Quintenstimmung, F-Löcher und die typische Korpusform), das bis in die Tenorlage hineinreicht.</p>
