...
const piccoloflute = { 
  id: 'oap-default-piccoloflute',
  name: 'piccoloflute',
  begin: 30,
  end: 51,
  color: colors.brass,
  text: `# Die Piccoloflöte
...
- Cl. Debussy, *Ibéria* (insbesondere Ziffer 33, T. 1–6)  
- D. Schostakowitsch, *Sinfonie Nr. 6*, 2. Satz  
...
- I. Stravinsky, *Petrushka*, *Russian Dance*`

};

export default piccoloflute;
