...
export default function TenorSaxophone({ from, to, row }) {
  ...
  const [begin, end] = OrchestrationUtilities.calculateGridColumnsForInstruments(14, 31, from, to); 
    ...
    <div className='instrument instrument-brass' style={{ gridColumn: calculation, gridRow: row }}>
      ...
      {isVisible
        ...
        <div className="instrument-annotations">
            <p>Das Tenorsaxofon ist ein Instrument aus der Saxofonfamilie. Dazu gehören:</p>
            <ul>
...
TenorSaxophone.propTypes = {
  from: PropTypes.number,
  to: PropTypes.number,
  row: PropTypes.number
};

TenorSaxophone.defaultProps = {
  from: 1,
  to: 50,
  row: null
};
